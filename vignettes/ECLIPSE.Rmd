...
actB_bams <- c(actB1_treat_path, actB2_treat_path)
naiveB_bams <- c(naiveB1_treat_path, naiveB2_treat_path)
...
naiveB_enhancers <- run_rose(treatment = naiveB1_treat_bw_path, 
                             control = naiveB1_control_bam, 
                             peaks = naive_mspc$GRangesObjects$ConsensusPeaks)

actB_enhancers <- run_rose(treatment = treat_actB1, 
                           control = control_actB1, 
...
all_SEs <- rbind(naiveB_SEs, actB_SEs)
